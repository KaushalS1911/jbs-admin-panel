...
import { Button, FormControl, InputAdornment, InputLabel, Typography } from '@mui/material';
...
const EmployeeAdd = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      try {
        const response = await axios.post(`${process.env.REACT_APP_API_URL}${profileData?.company_id}/employee`, values);
        resetForm();
        navigate('/employee');
      ...
      <MainCard className="form-outer">
        <div >
          <form action="" onSubmit={formik.handleSubmit}>
            ...
            >
              <Typography variant="h4" sx={{ color: '#5559CE', fontSize: '18px', fontWeight: 'bold', margin: '10px 8px 10px 0px' }}>
                Personal Details:
              </Typography>

              <Grid container spacing={2}>
                <Grid item xl={4} lg={4} md={6} sm={6} xs={12} sx={{ marginBottom: '10px' }}>
                  <TextField
                    label="First Name"
                    id="firstname"
                    name="firstName"
                ...
                <Grid item xl={4} lg={4} md={6} sm={6} xs={12} sx={{ marginBottom: '10px' }}>
                  <FormControl item={true}fullWidth variant="outlined">
                    <InputLabel id="developer-label" style={{ color: '#5559ce' }}>
                      Developer
                    </InputLabel>
                    <Select
                ...
                <Grid container spacing={2} sx={{ marginBottom: '20px' }}>
                  ...
                  <Grid item xl={4} lg={6} md={6} sm={6} xs={12}>
                    <FormControl item={true}fullWidth>
                      <InputLabel id="demo-simple-select-label" style={{ color: '#5559CE' }}>Country</InputLabel>
                      <Select
                  ...
                  <Grid item xl={4} lg={6} md={6} sm={6} xs={12}>
                    <FormControl item={true}fullWidth>
                      <InputLabel id="state-label" style={{ color: '#5559CE' }}>State</InputLabel>
                      <Select
                        labelId="state-label"
                        name="state"
                        label="state"
                      ...
                      >
                        <MenuItem disabled value={'Default State'} >-----Selected State----</MenuItem>
                  ...
                  <Grid item xl={4} lg={6} md={6} sm={6} xs={12}>
                    <FormControl item={true}fullWidth>
                      <InputLabel id="city-label" style={{ color: '#5559CE' }}>City</InputLabel>
                      <Select
                        labelId="city-label"
                        label="city"
                        name="city"
                        ...
                        onChange={formik.handleChange}
                      >
                        <MenuItem disabled value={'Default City'} >-----Selected State----</MenuItem>
              ...
              <Grid
                item xl={12} lg={12} md={12} sm={12} xs={12} sx={{ marginBottom: '20px' }}
                container
